...
| 2026-07-06 | (repo) + .gitignore | — | **Git-besluit uitgevoerd** (open P1 uit Full Governance Review 03.07): repo geïnitialiseerd op `main`; tekstlaag versioneerd (.claude/, blueprint/, knowledge/, reports/, CLAUDE.md, lees_pdf.py — 122 bestanden, commit 9999935); `raporlar/` en `portföyüm/` bewust uitgesloten (binaries/privacy; bron = broker-pipeline). Conventie: committen na betekenisvolle wijziging aan agents/blueprint/tooling. |
| 2026-07-06 | CLAUDE.md | — | Geactualiseerd naar de vier projectlagen (was: alleen data+tooling, stand 16.06): Project Layout-tabel incl. git-scope, governance-agents + agent-memory-conventies, DR-003/Methode B-regel, IC Raporları-sectie, portföyüm ruwe-data/bundel-routing, actuele İş Yatırım-naamgeving; commit 3131ca2. |
| 2026-07-06 | knowledge/ + reports/ (structuur) | — | 14 lege submappen verwijderd (8 knowledge-domeinen, 6 reports-outputmappen); taxonomie + bestandsnaamformats blijven als conventie in beide README's; submappen ontstaan just-in-time bij het eerste document; workflow-outputpaden ongewijzigd (geverifieerd); **ZD-0011**. |
| 2026-07-06 | knowledge/README.md, reports/README.md | v1.1 | Mapconventie-sectie toegevoegd (just-in-time aanmaak, git trackt lege mappen niet); reports-README aangevuld met de 3 ontbrekende outputlocaties (governance/documentation/risk) en cadansen; ZD-0011. |
| 2026-07-06 | governance/decision-register.md | — | ZD-0011 toegevoegd. Volgende nummer: ZD-0012. |
| 2026-08-07 | .claude/agents/{Macro-Stratejist,Hisse-Analist,Teknik-Analist,Risk-Yoneticisi}.md + CLAUDE.md | — | Halk Yatırım (3e broker, 9 categorieën) toegevoegd: nieuwe mapstructuur `raporlar/Halk Yatırım/1-9/`, Naamgevingsstandaard (`bron: halk`), mapscope-uitbreiding per specialist. **Direct edit op gebruikersverzoek, zónder Prompt-Architect/Architecture-Guardian-review** — blueprint-footers bewust ongewijzigd; drift gedocumenteerd in CLAUDE.md, retroactieve ZD nog te nummeren. |
| 2026-08-07 | CLAUDE.md + .claude/agents/Macro-Stratejist.md | — | Feitelijke correctie ELÜS-beschrijving: TÜRİB ELÜS = landbouwgrondstoffen (elektronische warehouse-receipts), niet "equity/liquidity strategy"; lage-prioriteit-annotatie in Macro-mapscope. De-prioritering/verwijdering uit de mapscope is een nog openstaande aparte keuze. |
| 2026-08-07 | .claude/agents/Master-Stratejist.md | — | Nieuwe sectie PRE-FLIGHT DATAKWALITEIT (5 verplichte checks vóór elke IC-run): T+1-bevestiging dagcijfers, TradingView-versheid per symbool (cache_note/data_date), Methode-A-detectie (DR-003), WebSearch-marge op gate-cijfers, netto-R:R-herrekening. Consolideert 5 memory-geleerde incidentregels (05-07.08, 23.07, 27.07, 29.07) tot afdwingbare promptregels. Zelfde direct-edit-modus als hierboven; Halk 1–9 aan Master-mapscope-regel toegevoegd. |
| 2026-08-07 | reports/pipeline/pipeline-fix-verzoeken-2026-08-07.md + reports/README.md | v1.0 | Nieuwe outputlocatie `reports/pipeline/` (just-in-time, ZD-0011-conventie): gebundelde verzoeklijst van 8 externe scraper-pipeline-gebreken (yfinance, stille cache-fallback, Gmail OAuth, fitz, stale Hisse Öneri, chart-screenshots, Methode-A-kader, İş-quota) voor doorzending aan de pipeline-beheerder. |
| 2026-08-07 | workflows/daily-monitor-workflow.md + .claude/agents/Master-Stratejist.md + CLAUDE.md | v1.0 | **Monitor-modus als default voor de dagelijkse check** (structuuranalyse punt 1): Master-only gate/trigger/portefeuille-check met escalatiecriteria E1–E7 naar de volledige IC-workflow; output in aparte `monitor_DDMMYYYY.md`-reeks; ~80% tokenbesparing bij ongewijzigde gates; ZD-0012. |
| 2026-08-07 | .claude/agents/Teknik-Analist.md + Master-Stratejist.md | — | **Broker-precedentieregel technische niveaus** (punt 3): ZFG primair, İş/Halk cross-checks, >1%-divergentie expliciet melden, geen stilzwijgende bronwissel binnen één setup, Sentiment Algo nooit niveaubron; ZD-0012. |
| 2026-08-07 | projectmemory (market_signals, portfolio_beslissingen) + agent-memory (reference_data_gaps_terugkerend.md) | — | **Memory-hygiëne** (punten 6-7): marktsignalen gesplitst in maandbestanden 2026-06/07/08 (actief = lopende maand, patroon vastgelegd); data-gaps-checklist geherstructureerd van 252-regels-logboek naar status-tabellen (open/opgelost/kwaliteitsregels) + chronologisch archief nieuwste-eerst; portefeuille-log mei-juli afgesplitst naar archiefbestand. |
| 2026-08-07 | governance/decision-register.md + 5 agent-footers | — | **ZD-0012 aangemaakt** (punt 9): retroactieve formalisering van alle 07.08-directe-edits (Halk-bron, monitor-modus, precedentieregel, pre-flight, flankerende punten); agent-footers → `DR-006, ZD-0012`; passport-updates gedelegeerd aan augustus-prompt-review. Volgende ZD-nummer: ZD-0013. |
| 2026-08-10 | blueprint/workflows/daily-monitor-workflow.md + .claude/agents/Risk-Yoneticisi.md | v1.1 | **GLDTR-rebalancing-trigger geformaliseerd tot herhaalbare dagelijkse check** (op gebruikersverzoek, n.a.v. vraag "wanneer inwisselen voor winst"): bij confirmed-close ≥575 TL/stuk trim-berekening naar 7-8%-midden van de 5-10%-band, expliciete uitzondering op de "geen nieuwe niveaus in monitor-modus"-regel (pure bandrekenkunde, geen nieuwe analyse); ook toegevoegd aan Risk-Yoneticisi's eigen TASK zodat volledige IC-runs 'm niet alleen via memory-continuïteit meenemen. Zelfde direct-edit-modus als ZD-0012; accumuleert richting de eerstvolgende prompt-review. |
